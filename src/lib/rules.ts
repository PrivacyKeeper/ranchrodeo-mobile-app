...
//
// Every app's table is named for its event (RR_PENALTIES), which is why this file
// is per-app and the screen that reads it is not.

import { RR_PENALTIES } from './scoring/index.ts';
...
export const RUN_ENDING_RULES: Record<string, RunEndingRule> = RR_PENALTIES;

export const RULES_HEADING = 'What ends a run';
export const RULES_INTRO =
  'Every penalty and disqualification across the ranch rodeo card, straight out of the rule engine this app scores with.';
