# Ranch Rodeo — mobile app

Placings become points before the dust settles.

Companion app for [ranchrodeo.pro](https://www.ranchrodeo.pro). Expo + expo-router,
Supabase, TypeScript.
...
Sanctioning bodies that matter here: WRCA.
